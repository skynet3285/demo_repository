package org.skynet.repository.api.v1.user.domain

import org.skynet.repository.common.PasswordEncoder
...
class User {
    ...
    private constructor (userId: Long, nickname: String, username: String, password: String, status: UserStatus, createdAt: OffsetDateTime, lastAccessAt: OffsetDateTime, role: UserRole) {
        this.userId = userId
